  ...
  return (
    <aside className="w-64 glass border-r border-white/5 flex flex-col relative z-20 shadow-[10px_0_30px_rgba(0,0,0,0.5)] h-full">
      ...
      <nav className="flex flex-col gap-2 p-4 flex-grow">
        ...
        <Link 
          to="/admin/blogs" 
          className={`px-4 py-3 rounded-xl transition-all font-medium tracking-wide text-sm flex items-center gap-3 ${isActive("blogs") ? "bg-[var(--color-electric-teal)]/10 text-[var(--color-electric-teal)] border border-[var(--color-electric-teal)]/20" : "text-gray-400 hover:text-white hover:bg-white/5"}`}
        >
